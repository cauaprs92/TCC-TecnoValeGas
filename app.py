...
from src.routers import cliente_bp, produto_bp, obra_bp, login_bp, admin_bp, responsavel_bp, relatorio_bp, historico_bp, servico_bp, fornecedor_bp, nota_fiscal_bp
