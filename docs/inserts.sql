...
-- idObra 1 — Concluida
(1,  'Instalação de ramal de gás em condomínio residencial',         '2024-08-05', '2024-08-28', 'Concluida',    'Carlos Souza',    'Testes de estanqueidade aprovados',           'Revisar juntas e conexões',            'Residencial', 'Supergásbras', 'Gás Canalizado', 'Un', 'caua.silva@sjcgas.com.br',            '(12) 98811-2233', NULL),
-- idObra 2 — Concluida
(1,  'Manutenção preventiva em medidor industrial',                   '2024-06-18', '2024-07-02', 'Concluida',    'Beatriz Almeida', 'Relatório enviado ao cliente',                'Confirmar próxima visita em 6 meses',  'Industrial', 'Supergásbras',  'Medidor',        'Un', 'caua.silva@sjcgas.com.br',            '(12) 98811-2233', NULL),
-- idObra 3 — Concluida
(2,  'Extensão de rede de gás em restaurante na região central',     '2024-09-01', '2024-10-15', 'Concluida',    'Renato Pereira',  'Liberação da prefeitura obtida',              'Agendar início após autorização',      'Comercial', 'Supergásbras',   'Rede de Gás',    'm',  'joao.vinicius@sjcgas.com.br',        '(12) 99777-4455', '(12) 98100-3344'),
-- idObra 4 — Concluida
(2,  'Correção de vazamento em cozinha industrial',                   '2024-04-10', '2024-05-08', 'Concluida',    'Ana Carolina',    'Válvula substituída e teste OK',              'Registrar em manutenção preventiva',   'Industrial', 'Supergásbras',  'Gás Natural',    'Un', 'joao.vinicius@sjcgas.com.br',        '(12) 99777-4455', NULL),
-- idObra 5 — Concluida
(3,  'Instalação de medidor privativo em prédio comercial',           '2024-07-22', '2024-09-10', 'Concluida',    'Carlos Souza',    'Peças entregues e instalação concluída',      'Revisar cronograma com fornecedor',    'Comercial', 'Supergásbras',   'Medidor',        'Un', 'mateus.alves@sjcgas.com.br',         '(12) 99666-7788', NULL),
-- idObra 6 — Concluida
(3,  'Troca de registro e conector em unidade logística',             '2024-05-12', '2024-06-01', 'Concluida',    'Beatriz Almeida', 'Obra entregue com novo certificado',          'Enviar notas fiscais',                 'Logística', 'Supergásbras',   'Conector',       'Un', 'mateus.alves@sjcgas.com.br',         '(12) 99666-7788', NULL),
-- idObra 7 — Pausada
(4,  'Instalação de ramal de gás para cozinha de pizzaria',           '2024-08-12', NULL,         'Pausada',      'Renato Pereira',  'Aguardando liberação do alvará de obra',      'Retomar após regularização',           'Comercial', 'Supergásbras',   'Gás Canalizado', 'm',  'lucia.martins@sjcgas.com.br',        '(12) 98123-4567', NULL),
-- idObra 8 — Concluida
(5,  'Revisão geral de rede de gás na unidade fabril',                '2024-07-01', '2024-08-10', 'Concluida',    'Ana Carolina',    'Painel de controle atualizado',               'Arquivar laudos de teste',             'Industrial', 'Supergásbras',  'Rede de Gás',    'm',  'fabricio.rocha@sjcgas.com.br',       '(12) 98222-3344', NULL),
-- idObra 9 — Em andamento
(6,  'Projeto de ramal de gás para nova loja de estética',            '2024-09-15', NULL,         'Em andamento', 'Carlos Souza',    'Levantamento concluído, execução em curso',   'Enviar orçamento final ao cliente',    'Comercial', 'Supergásbras',   'Projeto',        'Un', 'marina.nunes@sjcgas.com.br',         '(12) 98111-2233', NULL),
-- idObra 10 — Concluida
(7,  'Instalação de rede GLP para cozinha industrial',                '2025-01-10', '2025-01-24', 'Concluida',    'Renato Pereira',  'Instalação conforme ABNT NBR 15526',          'Utilizar tubulação de cobre 1/2"',     'Comercial', 'Supergásbras',   'GLP',            'Un', 'contato@bomsabor.com.br',            '(12) 3234-5678',  NULL),
-- idObra 11 — Em andamento
(8,  'Substituição de reguladores e mangueiras GLP',                  '2025-02-05', NULL,         'Em andamento', 'Carlos Souza',    'Aguardando chegada dos reguladores novos',    'Confirmar entrega com fornecedor',     'Manutenção', 'Supergásbras',  'GLP',            'Un', 'padaria@saobenedito.com.br',         '(12) 3123-4567',  NULL),
-- idObra 12 — Concluida
(9,  'Projeto de instalação GLP industrial - fase 1',                 '2025-02-15', '2025-03-30', 'Concluida',    'Beatriz Almeida', 'Projeto aprovado pela concessionária',        'Pressão de operação: 0,5 kgf/cm²',    'Industrial', 'Supergásbras',  'GLP',            'm',  'industria@textilvale.com.br',        '(12) 3456-7890',  '(12) 99611-1111'),
-- idObra 13 — Concluida
(10, 'Vistoria anual da central de GLP hospitalar',                   '2025-03-01', '2025-03-01', 'Concluida',    'Ana Carolina',    'Aprovada; válvula de segurança substituída',  NULL,                                   'Vistoria', 'Supergásbras',    'GLP',            'Un', 'adm@santacasataubate.org.br',        '(12) 3332-1000',  NULL),
-- idObra 14 — Pausada
(11, 'Adequação da rede GLP - setor de padaria',                      '2025-04-01', NULL,         'Pausada',      'Carlos Souza',    'Obra suspensa por reforma no teto do setor',  'Retomar após conclusão da reforma',    'Instalação', 'Supergásbras',  'GLP',            'm',  'gerencia@supbompreco.com.br',        '(12) 3251-8900',  '(12) 99388-0000'),
-- idObra 15 — Concluida
(12, 'Instalação industrial GLP - câmara fria',                       '2025-05-05', '2025-06-20', 'Concluida',    'Renato Pereira',  'Sistema de aquecimento de câmara fria OK',    'Pressão industrial: 1,5 kgf/cm²',     'Industrial', 'Supergásbras',  'GLP',            'm',  'compras@valecames.com.br',           '(12) 3612-5400',  '(12) 99166-8800'),
-- idObra 16 — Em andamento
(13, 'Revisão e adequação central GLP - hotel',                       '2025-06-15', NULL,         'Em andamento', 'Beatriz Almeida', 'Substituição de válvulas em curso',           'Adequar conforme NR-13',               'Manutenção', 'Supergásbras',  'GLP',            'Un', 'reservas@hotelfazendavale.com.br',  '(12) 3101-2200',  NULL),
-- idObra 17 — Concluida
(14, 'Instalação de rede GLP para cantina escolar',                   '2025-07-05', '2025-07-15', 'Concluida',    'Ana Carolina',    'Fogão 6 bocas instalado',                     NULL,                                   'Instalação', 'Supergásbras',  'GLP',            'm',  'secretaria@colegiodombosco.com.br', '(12) 3231-3300',  NULL),
-- idObra 18 — Cancelada
(15, 'Instalação de rede GLP para churrasqueiras - lote 1',           '2025-08-15', NULL,         'Cancelada',    'Carlos Souza',    'Cliente cancelou por mudança no projeto',     NULL,                                   'Instalação', 'Supergásbras',  'GLP',            'm',  'churrascaria@compadre.com.br',       '(12) 3153-8700',  '(12) 98389-9900'),
-- idObra 19 — Concluida
(16, 'Instalação de rede GLP para solda a gás',                       '2025-09-10', '2025-09-20', 'Concluida',    'Renato Pereira',  'Pontos de GLP para 6 postos de solda',        'Alta pressão de operação',             'Industrial', 'Supergásbras',  'GLP',            'm',  'producao@acoforte.com.br',           '(12) 3944-7600',  '(12) 98167-9000'),
-- idObra 20 — Pausada
(17, 'Instalação de fornos e fogões a GLP',                           '2025-10-01', NULL,         'Pausada',      'Beatriz Almeida', 'Equipamentos aguardando entrega do fornecedor','Confirmar prazo de entrega',           'Instalação', 'Supergásbras',  'GLP',            'Un', 'panificadora@delicia.com.br',        '(12) 3153-4400',  NULL),
-- idObra 21 — Concluida
(18, 'Instalação de forno industrial a gás cerâmica',                 '2025-11-03', '2025-11-28', 'Concluida',    'Carlos Souza',    'Queimadores de 100.000 BTU/h instalados',     'Temp. máxima: 1200°C',                 'Industrial', 'Supergásbras',  'GLP',            'Un', 'ceramica@ceramicasp.com.br',         '(12) 3241-9800',  '(12) 98944-6700'),
-- idObra 22 — Em andamento
(19, 'Instalação de GLP para cozinha escolar',                        '2025-11-20', NULL,         'Em andamento', 'Ana Carolina',    'Tubulação instalada, aguardando ligação final','Coordenar com equipe elétrica',        'Instalação', 'Supergásbras',  'GLP',            'm',  'escola@boavista.edu.br',             '(12) 3278-4500',  NULL),
-- idObra 23 — Concluida
(20, 'Ampliação da central de GLP - depósito 2',                      '2025-12-01', '2025-12-20', 'Concluida',    'Renato Pereira',  'Nova central com capacidade 12 botijões P45', NULL,                                   'Projeto', 'Supergásbras',     'GLP',            'Un', 'distribuidora@glpnorte.com.br',      '(12) 3627-9000',  '(12) 97834-5600'),
-- idObra 24 — Em andamento
(1,  'Manutenção corretiva - revisão geral pós-vistoria',             '2026-01-08', NULL,         'Em andamento', 'Carlos Souza',    'Aguardando laudo de estanqueidade',           'Emitir relatório técnico ao cliente',  'Manutenção', 'Supergásbras',  'GLP',            'Un', 'caua.silva@sjcgas.com.br',            '(12) 98811-2233', NULL),
-- idObra 25 — À iniciar
(10, 'Revisão semestral central de GLP hospitalar',                   '2026-06-30', NULL,         'À iniciar',    'Beatriz Almeida', 'Agendada para final de junho',                'Verificar normas ANVISA vigentes',     'Vistoria', 'Supergásbras',    'GLP',            'Un', 'adm@santacasataubate.org.br',        '(12) 3332-1000',  NULL),
-- idObra 26 — Em andamento
(9,  'Projeto de instalação GLP industrial - fase 2',                 '2026-03-03', NULL,         'Em andamento', 'Ana Carolina',    'Execução do setor de acabamento em curso',    'Integrar com rede existente da fase 1','Industrial', 'Supergásbras',  'GLP',            'm',  'industria@textilvale.com.br',        '(12) 3456-7890',  '(12) 99611-1111'),
-- idObra 27 — À iniciar
(12, 'Manutenção preventiva anual - frigorífico',                     '2026-07-07', NULL,         'À iniciar',    'Carlos Souza',    'Programada para julho; aguardando confirmação','Revisar todo o sistema de GLP',       'Manutenção', 'Supergásbras',  'GLP',            'Un', 'compras@valecames.com.br',           '(12) 3612-5400',  '(12) 99166-8800'),
-- idObra 28 — Pausada
(11, 'Instalação GLP - nova seção de frios supermercado',             '2026-05-05', NULL,         'Pausada',      'Renato Pereira',  'Obra embargada por fiscalização municipal',   'Resolver pendência com a prefeitura',  'Instalação', 'Supergásbras',  'GLP',            'm',  'gerencia@supbompreco.com.br',        '(12) 3251-8900',  '(12) 99388-0000'),
-- idObra 29 — Em andamento
(16, 'Ampliação da rede de GLP industrial - novo setor',              '2026-05-19', NULL,         'Em andamento', 'Beatriz Almeida', 'Integrar com rede existente',                 'Novo setor de produção em expansão',   'Instalação', 'Supergásbras',  'GLP',            'm',  'producao@acoforte.com.br',           '(12) 3944-7600',  '(12) 98167-9000'),
-- idObra 30 — Pausada
(15, 'Instalação de novo setor de churrasco - expansão',              '2026-06-16', NULL,         'Pausada',      'Carlos Souza',    'Cliente solicitou pausa para adequação civil', 'Aguardar liberação do cliente',        'Instalação', 'Supergásbras',  'GLP',            'm',  'churrascaria@compadre.com.br',       '(12) 3153-8700',  '(12) 98389-9900');
